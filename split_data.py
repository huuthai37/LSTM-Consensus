...
out_train_file = r'{}{}-train{}-split{}.pickle'.format(out_file_folder,dataset,num_seq,cross_index)
out_test_file = r'{}{}-test{}-split{}.pickle'.format(out_file_folder,dataset,num_seq,cross_index)
